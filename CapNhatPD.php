...
<?php 
	...
	if(isset($_GET['ma'])){
           ...
           $sql = "select Opi_Id, Id_In, Opi_Approved from opinion where Opi_Id = '$id'";
	...
	//nếu $Opi_Content khác rỗng thì tien hành cập nhật, nguoc lại thì k
	        ...
	        if($Opi_Approved !=""){
	        	if(isset($_POST['btnKiemDuyet'])){
	        		...
	        		if($loi ==""){
	        			$sql = "update opinion set Opi_Approved = '$nd' where Opi_Id = '$maykien' and Id_In = '$macv'";
				//die();
	        			$query = mysqli_query($conn, $sql);
...
<div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
	<h2 class="text-center">Cập nhật ý kiến Phê duyệt</h2>
					<form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
							  ...
							  <div class="form-group">
							    ...
							    <div class="col-sm-9">
							    	<textarea class="form-control" rows="5" id="comment" name="nd" placeholder="<?php echo $Opi_Approved;?>"></textarea>
